...
![Diff header showing branch information and action buttons](/images/vk-diff-header.png)
...
![Header showing disabled Push button after pull request creation](/images/vk-pr-open.png)
...
![Header showing enabled Push button with new changes ready](/images/vk-pr-with-push.png)
