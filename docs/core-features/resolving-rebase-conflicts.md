...
![Task showing rebase conflicts status with conflict resolution options](/images/vk-rebase-conflicts-top.png)

The conflict banner provides three options to resolve the situation:

![Conflict resolution banner showing the three available options](/images/vk-rebase-banner.png)
...
![Conflict resolution banner with auto-generated instructions in the follow-up field](/images/vk-rebase-conflicts-prompt.png)
