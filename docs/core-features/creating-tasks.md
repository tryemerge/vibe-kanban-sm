...
![Task creation interface showing Add Task button and form fields](/images/vk-task-dialog.png)
...
![Task tag autocomplete dropdown showing available tags after typing @ symbol](/images/screenshot-task-tag-autocomplete.png)
...
![Task attempt creation dialog showing agent profile and variant selection options](/images/vk-new-task-attempt.png)
