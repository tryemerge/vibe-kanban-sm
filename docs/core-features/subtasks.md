...
![Current attempt toolbar showing the Create Subtask button with GitFork icon](/images/vk-create-subtask-button.png)
...
![Task view showing a parent task with its associated subtasks listed in the Task Relationships panel](/images/screenshot-task-with-subtasks.png)
...
![Subtask detail view showing parent task information in the Task Relationships panel](/images/screenshot-subtask-parent-info.png)
