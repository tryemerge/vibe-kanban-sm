...
<video controls class="w-full aspect-video rounded-xl" src="https://vkcdn.britannio.dev/vk-mcp-server.mp4"></video>
...
![MCP Servers configuration page showing how to add Vibe Kanban MCP server](/images/vk-mcp-server-config.jpeg)
...
![Raycast MCP configuration - adding Vibe Kanban server](/images/vk-raycast-mcp-part-1.png)

Configure the Vibe Kanban MCP server in Raycast by adding the server details.

### Step 2: Supply Command

![Raycast MCP configuration - server successfully added](/images/vk-raycast-mcp-part-2.png)
