...
![MCP Server configuration page showing available servers and one-click installation options](/images/vk-mcp-server-config.jpeg)

## Popular MCP Servers

Vibe Kanban provides one-click installation for popular MCP servers.

![Popular MCP servers available for one-click installation](/images/vk-popular-mcp-servers.png)
