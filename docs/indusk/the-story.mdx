...
<div style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', borderRadius: '12px', padding: '2rem', marginBottom: '2rem', color: 'white', position: 'relative', overflow: 'hidden' }}>
  <div style={{ position: 'relative', zIndex: 1 }}>
    ...
    <h1 style={{ fontSize: '2.25rem', fontWeight: 800, margin: '0.5rem 0', color: 'white' }}>From Idea to Shipped Feature</h1>
    <p style={{ fontSize: '1.1rem', opacity: 0.9, margin: 0 }}>What happens when AI agents don't just execute — they learn</p>
  </div>
</div>
