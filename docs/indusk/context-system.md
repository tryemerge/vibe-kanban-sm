...
<InDuskHeader title="Context System" subtitle="How knowledge compounds and agents grow smarter over time" badge="InDusk Exclusive" />
...
::: details When to create global artifacts
...
::: details When to use path scope
...
::: details When to use task scope
...
::: details Writing good artifact content
